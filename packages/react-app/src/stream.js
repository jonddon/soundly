...
import { getBalance } from "./fDai";

// initialize superfluid(sf) for fakeDAI(fDai)
const sf = new SuperfluidSDK.Framework({
  ethers: ethers.getDefaultProvider(),
  tokens: ["fDAI"],
});
...
// get the details of a users current streaming
async function getFlowDetails(user) {
  return await user.details();
}
...
export { initializeUser, startFlow, stopFlow, getFlowDetails, getBalance };
